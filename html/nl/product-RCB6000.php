...
<?php include 'product-nav.php'; ?>
				<div class="span9">
					<a name="highlight"></a><h3>Industriële transmissiemodule type RCB6000</h3>
					<div class="row">
						<div class="span4">
					...
					<p></p>
					<p><a href="<?php echo Site::relativeUrl('RCB6000.pdf');?>" class="btn btn-success btn-small"><i class="icon-white icon-arrow-down"></i> Downloaden in pdf-formaat</a></p>

					<a name="features"></a><h4>Kenmerken</h4>
					<p>Draadloze transmissieapparatuur van JMei is geschikt voor de transmissie van elk type digitale of analoge signalen op afstanden <strong>tot 5.000 m</strong> en beperken aanzienlijk het gebruik van kabels voor controle of meting tussen apparaten en de PLC/automaat of tussen apparaten onderling. De RCB6000-modules zijn ook geschikt voor uitwisseling van signalen type RS232 of 485 of andere
.</p>
					<p>Bovendien zijn de JMei-/RCB 6000-modules voorzien van <strong>een processorkaart met twee microcontrollers die elk continu berichten herlezen</strong> en zo extra veiligheid bieden bij een systeemstoring.		<br>
De twee microcontrollers ageren tegelijk op een noodstoprelais dat op de processorkaart gemonteerd is en onmiddellijk elke mogelijke signaaltransmissie onderbreekt.</p>
					...
					<p>Het basissysteem van de RCB6000 bestaat uit een zenderbehuizing en een ontvangerbehuizing die via radiofrequentie elk type signaal kunnen verzenden of ontvangen als alles-of-niets of als analoge signalen.
                      <br>
                  Deze radiomodules kunnen zowel unidirectioneel als bidirectioneel communiceren op één enkele frequentie (technologie op basis van een tranceiver).</p>
					<p>De transmissiemodules maken gebruik van een technologie die gebaseerd is op onze uitgebreide ervaring op dit vlak (+/- 15 jaar), met bewezen prestaties <strong>in industriële sectoren zoals de staalindustrie, smelterijen op plaatsen waar de elektromagnetische omgeving heel storend kan zijn</strong>.<br />
				  Ze functioneren op frequentieband 434MHz of 868MHz (een frequentie die van rechtswege vrij is voor de gebruiker) met een laag vermogen (minder dan 10mW) om <strong>de andere radiogestuurde toepassingen op de site van de klant niet te verstoren</strong>.</p>
					...
					<ul>
                        ...
                        <li><strong>Beveiligde draadloze communicatie tussen mobiele machines met noodstoptransmissie</strong>.</li>
					...
					<p>De modules JMei/RCB6000 zijn uitgerust met voorzieningen en codes voor controle die ontwikkeld werden om een heel hoge betrouwbaarheidsgraad te garanderen met betrekking tot storingen of onderbrekingen van andere radiofrequentiebronnen ter plaatse. Dit gebeurt als volgt:</p>
<ul>
      ...
      <li>Extra beveiliging: de uitgangrelais worden bestuurd door twee afzonderlijke microprocessors die onderling communiceren en hun respectieve goede werking controleren. Bij een defect of storing van één van beide, gaat het systeem over naar veilige modus in afwachting van een nieuwe inschakeling uitgaand van de zender.</li>
					</ul>
					...
					<p>Dit type uitrusting werd recent geïnstalleerd bij: Arcelor Mittal, Riva Sidérurgie, Manoir industrie, Asco Métal, Burgo Ardenne, SAM Neuvemaison, Iton seine, Industrie automobile groupe Peugeot/SA, Glaverbel, Sidmar Gent, Airbus industrie.</p>
				</div>
			</div>
