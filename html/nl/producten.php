...
<<<<<<< HEAD
							...
							<br>
							RCB90L (Light): <br>
							- 9 tweefasige knoppen (2V).  <br>
							- 8 knoppen van 2V + 1 keuzeknop met 3 posities.<br>
							<br>
							RCB90M (Medium): <br>
							-
							14 tweefasige knoppen 	(2V). <br>
							- 11 knoppen van 2V + 3 keuzeknoppen met 3 posities.							</p>
							<p>Configuratie uni- of bidirectioneel (feedback via ledlampjes of een display met 7 segmenten).<br>
							<br>
