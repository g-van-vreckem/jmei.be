...
<?php include 'product-nav.php'; ?>
				<div class="span9">
					<a class="anchor" id="highlight"></a><h3>Memory and identification Key for IRC transmitter</h3>
					<div class="row">
						<div class="span4">
					...
					<p></p>
					<!--<p><a href="<?php echo Site::relativeUrl('KEY.pdf');?>" class="btn btn-success btn-large"><i class="icon-white icon-arrow-down"></i> Download PDF</a></p>-->
					<a class="anchor" id="features"></a><h4>Specification</h4>
					<p>IRC/INRADCO transmitters, type Helice, RCB90,RCB700, RCB1000 and RCB3000 are all configurable regarding frequencies and address, in safety and maintenance mode by trained maintenance people, following a clear IRC procedure.<br />
					This modification can be achieved by joysticks or push button impulses.</p>
					...
					<h4>Advantage of the IRC identification key</h4>
					<ul>
					...
					<a class="anchor" id="uses"></a><h4>Compatibility</h4>
					<ul>
