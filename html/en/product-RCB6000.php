...
<?php include 'product-nav.php'; ?>
				<div class="span9">
					...
					<ul>
						...
						<li>Upgrade security: all messages are controlled in real time by two micro controllers, providing à superior security class in case of system failure.<br />
					...
					<ul>
						...
						<li>RCB 6000 system is also able to translate data ( ex 0/10Vto 4/20mA, 0/5Vto RS232, ...)</li>
					</ul>
					<h6>Radio modem</h6>
					<ul>
