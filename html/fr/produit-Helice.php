...
industriel telle que mines et carrières, machines forestières et agricoles.</p>
					...
					<a name="specifications"></a><h4>Caractéristiques</h4>
					<ul>
						<li>Gamme de fréquence 433MHz ou bien 868MHz, 64 fréquences possibles.</li>
						<li>Emetteur et récepteur fréquence paramétrable par les boutons de commande, aucune intervention à faire sur le récepteur.</li>
						<li>Radio commande bidirectionnelle (option) ; le récepteur et l’émetteur se partagent le temps d’émission afin de n’utiliser qu’une seule fréquence.</li>
						<li>Portée de la radio commande en standard: 300m (option jusqu’à 3000m).</li>
						...
						<li>Batterie NiMh, sans effet de mémoire, à grande autonomie (>20h).</li>
						<li>Chargeur à microprocesseur de conception JMei ; temps de charge : 4 heures.</li>
						<li>Protection: IP 65.</li>
					</ul>
					<a name="gamme"></a><h4>Gamme</h4>
					<ul>
						<li>Jusque 8 boutons à bascule.</li>
					...
					<ul>
						...
						<li><a href="<?php echo Site::relativeUrl('TANDEM');?>">systèmes maitre esclave</a></li>
						<li>Afficheur</li>
					</ul>
				</div>
			</div>
