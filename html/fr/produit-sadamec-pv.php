<?php
	include 'common.php';
	$title = 'JMei - Pupitre Ventral Sadamec - Télécommande sans fil - Commande à distance robuste';
...
.</p>
				  ...
				  <p>Radiocommande en tôle d’aluminium extrêmement robuste et sécuritaire de haute performance de type pupitre ventral conçue pour les commandes de tout engin industriel dans les environnements lourds.</p>
						<p>Le PV est un pupitre ventral sans fil configurable à souhait et de grande qualité. 
Son design et les possibilités infinies de configuration autorisent toutes les possibilités de commandes de machines.</p>
				  ...
				  <h4>Avantages</h4>
					<ul>
						<li>2, 3 ou 4 manipulateurs 2 axes de fabrication interne (combinateurs Sadamec).</li>
				  ...
				  <h4>Accessoires</h4>
					<ul>
						<li>Harnais et housse de portage.</li>
						<li>Chargeur Sadamec/JMei.</li>
						<li>Accumulateur interchangeable NiMH 12V.</li>
