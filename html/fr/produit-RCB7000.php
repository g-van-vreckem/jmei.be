...
<?php include 'products-solutions-nav.php'; ?>
				<div class="span9">
					<a name="highlight"></a>
					<section>
                    <h3>Module de transmission industrielle de type RCB7000</h3>
					<div class="row">
						<div class="span4">
							<img class="img-polaroid" src="../img/product-RCB7000/rcb7000_1.png" alt="RCB7000 Transmission industrielle" />
						</div>
					</div>
					<p></p>		
