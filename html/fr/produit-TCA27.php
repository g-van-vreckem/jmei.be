...
<p>JMei a <strong>développé et breveté un équipement (TCA27)</strong> unique qui permet d’assurer toutes les fonctions de sécurité de la clé de prise en main <strong>sans pour autant devoir utiliser une source infrarouge</strong>.</p>
...
<img src="../img/product-TCA27/tca27_start_ok_fr.gif" alt="TAC 27 adaptation des émetteurs">
					...
					<a name="option"></a><h4>Limitation de la portée du système</h4>
<p>Afin de limiter au démarrage la portée de l’émetteur et d’obliger l’utilisateur à se rapprocher de son application, la balise peur être placée dans un tube métallique percé de 4 orifices, ce qui limite sa portée.</p>
<p>Ainsi l’opérateur devra se placer dans l’environnement proche de son pont roulant, grue ou toute autre application du moins dans la phase de démarrage et de sécurisation du système.</p>
					<a name="advantages"></a>
					<h4>Avantage du système TCA27 par rapport aux systèmes existants basés sur une source infrarouge</h4>
					<ul>
