...
?>
            ...
            <div class="row">
                <div class="span4">
					...
					<a href="<?php echo Site::relativeUrl('sadamec');?>"><img src="../img/home/box1EU.jpg?v=10" alt="Sadamec"></a>
					</section>
                </div>
                <div class="span4">
...
<h2 class="text-center">Industrial Wireless</h2>
					<a href="<?php echo Site::relativeUrl('products-radios');?>"><img src="../img/home/box4.png?v=7" alt="Radiocommande personnalisée"></a>
                    </section>
                </div>
            </div>
