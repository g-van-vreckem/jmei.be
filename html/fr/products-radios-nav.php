				...
				<!--Sidebar content-->
					...
					<div class="nav-collapse collapse products">
						<ul class="nav nav-tabs nav-stacked sidenavmix">
							...
							<li<?php echo Site::addActiveClass('JMSLYT'); ?>><a href="<?php echo Site::relativeUrl('JMSLYT');?>">S-LYT <i class="icon-chevron-right pull-right"></i></a></li>
							...
							<li<?php echo Site::addActiveClass('SADAMEC-BC'); ?>><a href="<?php echo Site::relativeUrl('SADAMEC-BC');?>">Sadamec BC<i class="icon-chevron-right pull-right"></i></a></li>
							...
							<li<?php echo Site::addActiveClass('SADAMEC-PV'); ?>><a href="<?php echo Site::relativeUrl('SADAMEC-PV');?>">Sadamec PV<i class="icon-chevron-right pull-right"></i></a></li>
