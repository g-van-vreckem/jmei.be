                  ...
                  <a id="réalisations"></a>
					...
					<div class="row">
						<div class="span3">
							...
							<img src="../img/product-SMS/sms_bot1.jpg?v=1" alt="Commande SMS">    
						</div>
						<div class="span3">
							<h6>Pilotage via smartphone</h6>
							<img src="../img/product-SMS/sms_bot2.jpg" alt="Commande Smartphone">
						</div>
						<div class="span3">
							<h6>Retour d'info via SMS</h6>
							<img src="../img/product-SMS/sms_bot3.jpg?v=1" alt="Relai SMS">
						</div>                                                
					</div>         
				</div>
			</div>
