                  ...
                  <h4>Applications embarquées</h4>
					...
					<div class="row">
						<div class="span3">
							...
							<img src="../img/product-RECF/recf_bot1.jpg?v=1" alt="Récepeur Fieldbus">
						</div>
						<div class="span3">
							<h6>Connecteurs industriels</h6>
							<img src="../img/product-RECF/recf_bot2.jpg?v=1" alt="Radiocommande industrielle">
						</div>
						<div class="span3">
							<h6>Quick support RECF </h6>
							<img src="../img/product-RECF/recf_bot3.jpg?v=1" alt="Radiocommande industrielle">
						</div>                                                
					</div>                      
				</div>
			</div>
