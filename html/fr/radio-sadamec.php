...
<?php echo $swiper->html; ?>
	...
	<p><strong>JMei</strong> est au cœur de la radiocommande depuis 30 ans par les sociétés Collard-IRC et JMei. Elle est basée en Belgique francophone (Ardennes belges) et impliquée sur le marché français de même que sa filliale JMei France SARL.<br>
        Elle se fera un plaisir de vous satisfaire dans des délais courts et d’analyser avec vous vos besoins en radiocommande.<br>
		JMei fabrique vos radios sur-mesure en respectant les normes sécuritaires imposées dans votre secteur. <br>
		<strong>JMei et JMei France</strong> sont certains de par cette décision de mieux répondre aux demandes du secteur industriel.</p>
	</section>
	<hr> 
	<section>
