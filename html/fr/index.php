...
?>
            ...
            <div class="row">
                ...
                <div class="span4">
						<h2>JMei vous souhaite de joyeuses fêtes</h2>
 <!-- /.Radios personnalisées! -->          
                    <a href="<?php echo Site::relativeUrl('realisations');?>" style="text-align: left"><img src="../img/home/month-radio.gif?v=9" alt="Radiocommande Industrielle de sécurité"></a>
               </div>
                <div class="span4">
